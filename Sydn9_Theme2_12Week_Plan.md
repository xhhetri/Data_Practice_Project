# Sydn9 – Theme 2: 12-Week Execution Plan
...
## Notes
- **Standing practice (every week):** weekly stand-up, PR review before merge, scope-change issues logged with rationale, milestone burndown checked against this table.
- **Buffer built in:** Weeks 11–12 are lighter on new development and heavier on QA/integration — this is where most group projects lose marks if skipped.
- Adjust the exact role names above if your team has already informally settled into different roles — the workstream structure is what matters for the report's project-management evidence section.
